    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('RENT', 'Rent'), ('FOOD', 'Food'), ('ENTERTAINMENT', 'Entertainment'), ('TRANSPORTATION', 'Transportation'), ('MEDICAL', 'Medical'), ('OTHER', 'Other')], max_length=50)),
